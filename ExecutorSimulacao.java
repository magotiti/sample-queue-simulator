...
public class ExecutorSimulacao {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=====================================");
        SimuladorRede simuladorBaseline = ConfigLoader.carregarModelo("model_baseline.txt");
        ...
        System.out.println("=====================================");
        SimuladorRede simuladorImproved = ConfigLoader.carregarModelo("model_improved.txt");
