...
// public FilaSimples(int servidores, int capacidade, double minChegada, double
// maxChegada, double minServico, double maxServico) {
...
// if (tempoServico != -1) {
// escalonadorEventos.add(new Evento(Evento.TipoEvento.SAIDA, tempoGlobal +
// tempoServico));
// }
// }
...
// escalonadorEventos.add(new Evento(Evento.TipoEvento.CHEGADA, tempoGlobal +
// tempoProximaChegada));
// }
// }
...
// System.out.printf("\nfila: G/G/%d/%d / chegadas: %.1f-%.1f / atendimento:
// %.1f-%.1f\n",
